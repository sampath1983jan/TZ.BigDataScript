...
{
    public partial class ClientComponentBuilder : Form
    {
        ...
        public ClientComponentBuilder(int clientID,string conn)
        {
            ClientID = clientID;
            connection = conn;
            InitializeComponent();
      ...
      CompList = ComponentDataHandler.GetComponents(connection);
        ...
        private void btnSaveAttribute_Click(object sender, EventArgs e)
        {
            ...
            cm.SaveAttribute(this.ClientID, SelectedAttribute);
            bindAttributeList();
        }
