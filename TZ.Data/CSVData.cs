...
namespace TZ.Data
{
    ...
    public class CSVData
    {
        ...
        private static CSVItem ParseArrayItem(string data) {

            string pattern = @"""\s*,\s*""";
            string[] all = System.Text.RegularExpressions.Regex.Split(
    data.Substring(1, data.Length - 2), pattern);
        ...
        private static CSVItem ParseItem(string data)
        {
            ...
            string[] all = CSVParser.Split(data);  
